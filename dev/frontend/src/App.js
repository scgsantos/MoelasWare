    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route
                    exact
                    path={TEST_PUBLISHED_URL}
                    element={<CreateTestLastPage />}
                />
                ...
                <Route exact path={USERS_URL} element={<Users />}>
                    <Route
                        exact
                        path=":id"
                        element={<History selected="users" />}
                    />
                </Route>
                ...
                <Route path="/createquiz" element={<CreateQuiz />}>
                    <Route
                        path="/createquiz/myquiz/:id/"
                        element={<MyQuiz />}
                    />
                </Route>

                <Route path="/createquiz/new" element={<NewQuiz />} />
                <Route path="/createquiz/edit/:id" element={<EditQuiz />} />
                <Route path="/createquiz/drafts" element={<Drafts />}></Route>
                ...
                <Route
                    exact
                    path={REVIEW_QUIZ_URL + ":id"}
                    element={<ReviewAQuizPage />}
                />
            </Routes>
        </Router>
    );
