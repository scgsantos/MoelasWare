...
import { CREATE_RANDOM_TEST_URL,CREATE_TEST_URL, MENU_URL, CREATE_TEST_WITH_TAGS_URL } from "urls.js";
import 'common.css';
...
function CreateTestMenu() {
  ...
  return (
    <div>
      ...
      <section onMouseOver={() => handleMouseOver()} onMouseOut={() => handleMouseOut()} className='CreateTestPanel-section'>
        <CreateTestPanel text="RANDOM TEST" description="Completely random quizzes will be selected for the test" onClick={() => handleCreateRandomTestButton()} />
        <CreateTestPanel text="RANDOM TEST WITH SPECIFICATIONS" description="You choose the topics you want to appear in the quizzes" onClick={() => handleCreateRandomTestWithTagsButton()} />
        <CreateTestPanel text="CHOOSE QUIZZES FOR THE TEST" description="You choose each quizz you want for your test" onClick={() => handleCreateTestButton()} />
      </section>
