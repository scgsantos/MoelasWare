    ...
    <div>
      ...
      <div className="loc">
        <div className="login">
          ...
          <input id="username_log" type="username" placeholder='username'></input>
          <input id="password_log" type="password" placeholder='password'></input>
          <button type="enter_log" onclick="#login">ENTER</button>
        </div>
        <div className="register">
          <h2>
            REGISTER
          </h2>
          <input id="username_reg" type="username" placeholder='username'></input>
          ...
          <button type="enter_reg" onclick="#register">ENTER</button>
        </div>
      </div>
    </div>
  );
