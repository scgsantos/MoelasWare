...
def quiz_finished_serializer_handler(data):
    quiz_list = []
    for i in data:
        quiz_list.append([i['id'],i['name'], i['tags'],i['number_of_reviews_done'], i['review_result']])
    return quiz_list
...
def handle_frontend_fields(dataRequest):
    ...
    justification_list = ['justification1', 'justification2', 'justification3', 'justification4', 'justification5', 'justification6']
        ...
        match i:
            ...
            case 'justification':
                if type(data['justification']) is list and len(data['answers']) > 0 and len(data['answers']) <= 6:     
                    ...
                    return JsonResponse({"resposta" : "Wrong Data for Justification Field"})
            ...
            case 'correct':
                if type(data['correct']) is str and len(data['correct']) > 0:
                    ...
                    return JsonResponse({"resposta" : "Wrong Data for Correct Field"})
        ...
        match i:
            ...
            case 'correct':
                if type(data['correct']) is int and data['correct'] > 0 and data['correct'] <= 6:
                    ...
                    return JsonResponse("Wrong Data for Correct Field")
